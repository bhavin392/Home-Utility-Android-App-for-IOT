...
//        Log.d(TAG,params[0]);
        ...
        editor.commit();
        String urlLogin = "http://169.254.217.160/49ersense/login.php";
        String urlRegister ="http://169.254.217.160/49ersense/register.php";
        String urlUpdate="http://169.254.217.16049ersense/updateMySettings.php";
        String urlRegisterAdmin="http://169.254.217.160/49ersense/admin/register.php";
        String urlLoginAdmin="http://169.254.217.160/49ersense/admin/login.php";
        String urlAdminUserDetails="http://169.254.217.160/49ersense/userdetails.php";
        String urlAdminEnerngyBreakdown="http://169.254.217.160/49ersense/energyBreakdown.php";

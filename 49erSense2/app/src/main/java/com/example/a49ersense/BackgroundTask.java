...
//        Log.d(TAG,params[0]);
        ...
        editor.commit();
        String urlLogin = "http:/ur ip address/49ersense/login.php";
        String urlRegister ="http://ur ip address/49ersense/register.php";
        String urlUpdate="http://ur ip address/49ersense/updateMySettings.php";
        String urlRegisterAdmin="http://ur ip address/49ersense/admin/register.php";
        String urlLoginAdmin="http://ur ip address/49ersense/admin/login.php";
        String urlAdminUserDetails="http://ur ip address/49ersense/userdetails.php";
        String urlAdminEnerngyBreakdown="http://ur ip address/49ersense/energyBreakdown.php";
